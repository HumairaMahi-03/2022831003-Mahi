...
bool initializeSDL(SDL_Window** frontend, SDL_Renderer** renderer)
{
    ...
    *frontend = SDL_CreateWindow("Created by Humaira Mahi -03", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
...
int main(int argc, char* argv[])
{
    ...
    while (running)
    {
        ...
        SDL_SetRenderDrawColor(renderer, 255, 224, 227, 255);
        SDL_RenderClear(renderer);

            
        SDL_SetRenderDrawColor(renderer, 150, 40, 100, 255);
